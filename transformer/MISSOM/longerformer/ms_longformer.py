...
class Config:
    ...
    TEST_DATA = "test.csv"
    BERT_PATH = "allenai/longformer-base-4096"
    TOKENIZER = transformers.LongformerTokenizer.from_pretrained(BERT_PATH, do_lower_case=True)
    MODEL = transformers.LongformerModel.from_pretrained(BERT_PATH, return_dict=False)
...
class LongformerModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        dbo = self.dropout(mean_last_hidden_state)
        output = self.out(dbo)
        return output
